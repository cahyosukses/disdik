...
$root_path = '/disdik/texteditor'; 					//path from webroot, without trailing slash. If your page is located in http://www.example.com/john/, this should be '/john'
$thmb_size = 250;       	//max size of preview thumbnail
