...
?>
	...
	<div class="span12 wellwhite" style="margin-left: 0px;">
	   ...
	   <form class="form-search" method="POST" action="">
	      ...
	      <label class="control-label" for="inputEmail" style="margin-left:10px"> - </label>
	      ...
	      <button type="submit" style="margin-top:10px" class="btn">Cari</button>
	      <a href="<?php echo base_url() . 'tampil/reset_search/prod_hukum/' . $id_prod_hukum;?>"><button type="button" style="margin-top:10px" class="btn btn-success"> Reset</button></a>
	   </form>
	   <hr>
