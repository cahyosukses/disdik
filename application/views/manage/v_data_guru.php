...
<div class="row-fluid">
	<div class="span12">
		<ul class="breadcrumb wellwhite">
			...
			<li>Guru <?php echo $nama_sekolah?></li>
		</ul>
	</div>
</div>
...
<button class="btn btn-primary" type="button" onclick="window.open('<?php echo base_URL() . 'manage/data_guru/' . $id_sekolah . '/import/'; ?>', '_self')">Import Data</button>
<br><br>
