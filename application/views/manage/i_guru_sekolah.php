...
<div class="row-fluid">
	<div class="span12">
		<ul class="breadcrumb wellwhite">
			...
			<li><a href="<?php echo base_URL() . 'manage/data_guru/' . $id_sekolah;?>">Guru <?php echo $nama_sekolah;?></a><span class="divider">/</li>
			<li>Import Data Guru</li>
		</ul>
	</div>
</div>

<legend>Import Data Guru <?php echo $nama_sekolah?></legend>
<div class="alert alert-success">Pada form ini anda bisa melakukan import data guru sekolah sesuai dengan format file excel dibawah ini<br>
	<a href="<?php echo base_URL() . 'upload/data_guru.xls'?>">Download Format Excel Data Guru Sekolah</a>
</div>
...
<form action="<?php echo base_URL()?>manage/data_guru/<?php echo $id_sekolah;?>/import_act" method="post" accept-charset="utf-8" enctype="multipart/form-data">	
