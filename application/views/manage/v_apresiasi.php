<style type="text/css">
	...
	<h3>Ruang Apresiasi</h3>
	<form action="<?php echo base_URL() . 'manage/apresiasi/cari'?>" method="post">		
	...
	<?php echo $this->session->flashdata("k");?>	
		<table width="100%"  class="table table-condensed">
		   ...
		   <tr <?php echo $b->tampil === 'N' ? 'class="warning"':'class="success"'?>>			      
		      ...
		      <td><?php echo ucfirst($b->nama_pengirim)?></td>
		      <td><?php echo $b->email_pengirim?></td>		     
	...
	<center>
  	...
  	<script type="text/javascript">
	  	$('.change_tampil').click(function() {
	  		...
	  		$.post("<?php echo base_url() . 'manage/apresiasi/set_tampil';?>", 
	        			{ id: id_ide ,
	        			  tampil : val_tampil } 
	        	).done(function(data){
