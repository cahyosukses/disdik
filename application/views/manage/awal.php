...
<table width="100%"  class="table table-condensed" >
	...
	?>
	<tr><td><?php echo $laris->judul?></td><td class="tengah"><?php echo $laris->hits?> kali dibaca</td></tr>
	<?php 
	}
	?>
</table>
...
<table width="100%"  class="table table-condensed" class="span8">
	...
	?>
	<tr><td><?php echo $komen->judul?></td><td class="tengah"><?php echo $komen->komen?> kali dikomentari</td></tr>
	<?php 
	}
	?>
</table>
