<style type="text/css">
	...
	<form action="<?php echo base_URL() . 'manage/ide_saran/cari'?>" method="post">		
		...
		<table width="100%"  class="table table-condensed">
		   ...
		   <tr <?php echo $b->tampil === 'N' ? 'class="warning"':'class="success"'?>>			      
		      ...
		      <td style="text-align: center" id="row_<?php echo $b->id;?>">
		      	...
		      	<?php } ?>  
		        <a href="<?php echo base_URL(); ?>manage/ide_saran/reply/<?php echo $b->id?>"><span class="icon-pencil">&nbsp;&nbsp;</span></a>  
			    <a href="<?php echo base_URL(); ?>manage/ide_saran/del/<?php echo $b->id ?>" onclick="return confirm('Anda YAKIN menghapus data ini ?');"><span class="icon-remove">&nbsp;&nbsp;</span></a>
		      </td>
		   </tr>
		   <?php endforeach; ?>	
		   <?php } ?>	  
	...
	<center>
  	...
  	<script type="text/javascript">
	  	$('.change_tampil').click(function() {
	  		...
	  		$.post("<?php echo base_url() . 'manage/ide_saran/set_tampil';?>", 
	        			{ id: id_ide ,
	        			  tampil : val_tampil } 
	        	).done(function(data){
