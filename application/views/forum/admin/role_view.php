<div class="span10">  
    ...
    <div class="modal hide" id="modalConfirm">
        ...
        <p style="text-align: center;">Apakah anda yakin untuk menghapus role ini ?</p>
        </div>
    ...
    <div class="alert alert-info">
        ...
        <h4 class="alert-heading">Role telah dihapus!</h4>
    </div>
    <?php endif; ?>
    ...
    <div class="span8">
        ...
        <tbody>
             <tr>
                <?php foreach ($roles as $role): ?>
                <td>
                    <a title="edit" href="<?php echo site_url('forum/admin/role_edit').'/'.$role['id']; ?>"><img src="<?php echo base_url(); ?>assets/forum//icons/pencil.png"/></a> 
                    &nbsp;&nbsp;
                    <a title="delete" class="del" id="role_id_<?php echo $role['id']; ?>" href="<?php echo site_url('forum/admin/role_delete').'/'.$role['id']; ?>"><img src="<?php echo base_url(); ?>assets/forum//icons/delete.png"/></a> 
                </td>
                <?php endforeach; ?>
            </tr>
			<tr>
                ...
                <td>
                    ...
                    <img src="<?php echo base_url(); ?>assets/forum//icons/accept.png"/>
                    <?php else: ?>
                    <img src="<?php echo base_url(); ?>assets/forum//icons/stop.png"/>
                    <?php endif; ?>
                </td>
                <?php endforeach; ?>
            </tr>
