<div class="span10">  
    ...
    <div class="modal hide" id="modalConfirm">
        ...
        <p style="text-align: center;">
            ...
            <br/>
            <span style="font-weight: bold;color:#ff0000;font-size: 14px;">Semua post dalam thread ini akan dihapus<span>
        </p>
        </div>
    ...
    <tbody>
        ...
        <td style="text-align: center;"><a title="edit" href="<?php echo site_url('forum/admin/thread_edit').'/'.$thread->id; ?>"><img src="<?php echo base_url(); ?>assets/forum//icons/pencil.png"/></a> </td>
        <td style="text-align: center;"><a title="delete" class="del" id="thread_id<?php echo $thread->id; ?>" href="<?php echo site_url('forum/admin/thread_delete').'/'.$thread->id; ?>"><img src="<?php echo base_url(); ?>assets/forum//icons/delete.png"/></a> </td>
        </tr>
        <?php endforeach; ?>
    </tbody>
    </table>
