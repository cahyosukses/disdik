...
<div class="span6">
    ...
    <input type="text" id="slug" name="row[slug]" title="<?php echo site_url('forum/thread/talk/'.$thread->slug); ?>" value="<?php echo $thread->slug; ?>" disabled="disabled" class="span12 disabled" placeholder="">
