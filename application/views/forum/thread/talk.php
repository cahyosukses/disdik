...
<div class="row-fluid">
    <div class="span9">
        ...
        <div class="alert alert-success">
            ...
            <h4 class="alert-heading">Reply telah terkirim!</h4>
        </div>
        <?php endif; ?>
        <?php if (isset($tmp_success_new)): ?>
        <div class="alert alert-success">
            <a class="close" data-dismiss="alert" href="#">&times;</a>
            <h4 class="alert-heading">Thread baru telah dibuat!</h4>
        </div>
        <?php endif; ?>
        ...
        <?php foreach ($posts as $post): ?>
            <div class="well" style="font-family: Verdana;">
                ...
                <span style="font-size:11px;float:right;position: relative;top:14px;">
                    ditulis oleh <?php echo $post->username; ?>, <?php echo time_ago($post->date_add); ?>
                </span>
