...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
   ...
   <body>
      ...
      <img src="<?php echo base_URL() . "timthumb?src=/upload/". $header_img;?>&w=960&h=100&zc=0" style="width: 960px; height: 100px; display: inline; margin: -5px 0 5px 0">
      ...
      <div style="margin: -35px 0px 0px 940px; display: inline; position: absolute" class="pull-right">
         ...
         <div class="carousel-inner">
            ...
            <div class="item <?php echo $i == 1 ? 'active':'';?>">
               ...
               <div class="carousel-caption">
                  <!--
                  http://localhost/disdik/tampil/blog/baca/4/tim-pengembang-konten
                  -->
