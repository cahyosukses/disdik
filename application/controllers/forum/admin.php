...
class Admin extends CI_Controller {    
    ...
    {
        $this->data['title']   = 'Admin Index :: '.FORUM_TITLE;
        $this->load->view('forum/header', $this->data);
        $this->load->view('forum/admin/sidebar');
        $this->load->view('forum/admin/index');
    ...
    public function user_view()
    {
        ...
        $this->data['title']   = 'Admin Users View :: '.FORUM_TITLE;
        $this->load->view('forum/header', $this->data);
        $this->load->view('forum/admin/sidebar');
        $this->load->view('forum/admin/user_view');
        $this->load->view('forum/footer');
    }
    ...
    public function user_create(){
        if ($this->input->post('btn-create')) {
            ...
            if ($this->forum_user_m->error_count != 0) {
                ...
                redirect('forum/admin/user_create');
            }
        }
        ...
        $this->data['title']   = 'User Create :: '.FORUM_TITLE;
        $this->load->view('forum/header', $this->data);
        $this->load->view('forum/admin/sidebar');
        $this->load->view('forum/admin/user_create');
        $this->load->view('forum/footer');
    }
    ...
    public function user_edit($user_id)
    {
        if ($this->input->post('btn-save')) {
            $this->forum_admin_m->user_edit();
            if ($this->forum_admin_m->error_count != 0) {
                $this->data['error']    = $this->forum_admin_m->error;
            } else {
                $this->session->set_userdata('tmp_success', 1);
                redirect('forum/admin/user_view');
            }
        ...
        $this->load->view('forum/header', $this->data);
        $this->load->view('forum/admin/sidebar');
        $this->load->view('forum/admin/user_edit');
        $this->load->view('forum/footer');
    }
    // end user function
    ...
    public function role_create()
    {
        ...
        if ($this->input->post('btn-create'))
        {
            $this->forum_admin_m->role_create();
            if ($this->forum_admin_m->error_count != 0) {
                $this->data['error']    = $this->forum_admin_m->error;
            } else {
                $this->session->set_userdata('tmp_success', 1);
                redirect('forum/admin/role_create');
            }
        }
        ...
        $this->data['title']   = 'Admin Role Create :: '.FORUM_TITLE;
        $this->load->view('forum/header', $this->data);
        $this->load->view('forum/admin/sidebar');
        $this->load->view('forum/admin/role_create');
        $this->load->view('forum/footer');
    }
    ...
    public function role_view()
    {
        ...
        $this->load->model('forum_admin_m');
        $this->data['roles'] = $this->forum_admin_m->role_get_all();
        $this->data['column_width'] = floor(100 / count($this->data['roles']));
        $this->data['title']   = 'Admin Role View :: '.FORUM_TITLE;
        $this->load->view('forum/header', $this->data);
        $this->load->view('forum/admin/sidebar');
        $this->load->view('forum/admin/role_view');
        $this->load->view('forum/footer');
    }
    ...
    public function role_edit($role_id)
    {
        ...
        if ($this->input->post('btn-edit')) {
            ...
            if ($this->forum_admin_m->error_count != 0) {                
                ...
                $this->session->set_userdata('tmp_success', 1);
                redirect('forum/admin/role_edit/'.$role_id);
            }
        }
        $tmp_success = $this->session->userdata('tmp_success');
        if ($tmp_success != NULL) {
        ...
        $this->data['title']   = 'Admin Role Edit :: '.FORUM_TITLE;
        $this->load->view('forum/header', $this->data);
        $this->load->view('forum/admin/sidebar');
        $this->load->view('forum/admin/role_edit');
        $this->load->view('forum/footer');
    }
    ...
    public function role_delete($role_id)
    {
        ...
        $this->session->set_userdata('tmp_success_del', 1);
        redirect('forum/admin/role_view');
    }
    // end roles function
    ...
    public function category_create()
    {
        ...
        if ($this->input->post('btn-create')) {
            ...
            if ($this->forum_admin_m->error_count != 0) {
                ...
                $this->session->set_userdata('tmp_success', 1);
                redirect('forum/admin/category_create');
            }
        }
        ...
        $this->data['title']   = 'Admin Category Create :: '.FORUM_TITLE;
        $this->load->view('forum/header', $this->data);
        $this->load->view('forum/admin/sidebar');
        $this->load->view('forum/admin/category_create');
        $this->load->view('forum/footer');
    }
    ...
    public function category_view()
    {
        ...
        $this->data['categories'] = $this->forum_admin_m->category_get_all();
        $this->data['title']   = 'Admin Category View :: '.FORUM_TITLE;
        $this->load->view('forum/header', $this->data);
        $this->load->view('forum/admin/sidebar');
        $this->load->view('forum/admin/category_view');
        $this->load->view('forum/footer');
    }
    ...
    public function category_edit($category_id)
    {
        ...
        if ($this->input->post('btn-edit')) {
            ...
            if ($this->forum_admin_m->error_count != 0) {
                ...
                $this->session->set_userdata('tmp_success', 1);
                redirect('forum/admin/category_edit/'.$category_id);
            }
        }
        $tmp_success = $this->session->userdata('tmp_success');
        if ($tmp_success != NULL) {
        ...
        $this->data['categories'] = $this->forum_admin_m->category_get_all();
        $this->data['title']   = 'Admin Category Edit :: '.FORUM_TITLE;
        $this->load->view('forum/header', $this->data);
        $this->load->view('forum/admin/sidebar');
        $this->load->view('forum/admin/category_edit');
        $this->load->view('forum/footer');
    }
    ...
    public function thread_view($start = 0)
    {
        ...
        $this->data['threads'] = $this->forum_admin_m->thread_get_all($start, $this->page_config['per_page']);
        $this->data['title']   = 'Admin Thread View :: '.FORUM_TITLE;
        $this->load->view('forum/header', $this->data);
        $this->load->view('forum/admin/sidebar');
        $this->load->view('forum/admin/thread_view');
        $this->load->view('forum/footer');
    }
    ...
    public function thread_edit($thread_id)
    {
        ...
        if ($this->input->post('btn-save'))
        {
            $this->forum_admin_m->thread_edit();
            if ($this->forum_admin_m->error_count != 0) {
                $this->data['error']    = $this->forum_admin_m->error;
            } else {
                $this->session->set_userdata('tmp_success', 1);
        ...
        $this->load->view('forum/header', $this->data);
        $this->load->view('forum/admin/sidebar');
        $this->load->view('forum/admin/thread_edit');
        $this->load->view('forum/footer');
    }
